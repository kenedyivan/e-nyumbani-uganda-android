...
public class AddPropertyActivity extends AppCompatActivity {
    ...
    private String TAG = AddPropertyActivity.class.getSimpleName();
        ...
        mAddProperty.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (mTitle.getText().toString() != null && !mTitle.getText().toString().isEmpty()) {
                    ...
                    Toast.makeText(AddPropertyActivity.this, "Title empty", Toast.LENGTH_SHORT).show();
                    return;
                }
                ...
                if (mDescription.getText().toString() != null && !mDescription.getText().toString().isEmpty()) {
                    ...
                    Toast.makeText(AddPropertyActivity.this, "Description empty", Toast.LENGTH_SHORT).show();
                    return;
                }
                ...
                if (mPrice.getText().toString() != null && !mPrice.getText().toString().isEmpty()) {
                    ...
                    Toast.makeText(AddPropertyActivity.this, "Price empty", Toast.LENGTH_SHORT).show();
                    return;
                }
                ...
                if (mAddress.getText().toString() != null && !mAddress.getText().toString().isEmpty()) {
                    ...
                    Toast.makeText(AddPropertyActivity.this, "Address empty", Toast.LENGTH_SHORT).show();
                    return;
                }
                ...
                if (mDistrict.getText().toString() != null && !mDistrict.getText().toString().isEmpty()) {
                    ...
                    Toast.makeText(AddPropertyActivity.this, "District empty", Toast.LENGTH_SHORT).show();
                    return;
                }
                ...
                if (mTown.getText().toString() != null && !mTown.getText().toString().isEmpty()) {
                    ...
                    Toast.makeText(AddPropertyActivity.this, "Town is empty", Toast.LENGTH_SHORT).show();
                    return;
                }
                ...
                if (mRegion.getText().toString() != null && !mRegion.getText().toString().isEmpty()) {
                    ...
                    Toast.makeText(AddPropertyActivity.this, "Region is empty", Toast.LENGTH_SHORT).show();
                    return;
                }
                ...
                if (type[0] != null && !type[0].isEmpty()) {
                    ...
                    Toast.makeText(AddPropertyActivity.this, "Type not selected", Toast.LENGTH_SHORT).show();
                    return;
                }
                ...
                if (!title.isEmpty() && !description.isEmpty() && !price.isEmpty()
                    ...
                    Toast.makeText(AddPropertyActivity.this, "Cannot read fields", Toast.LENGTH_SHORT).show();
                }
    ...
    private void upload(Uri uri) {
        ...
        client.post(AppData.uploadPhoto(), params, new AsyncHttpResponseHandler() {
            ...
            public void onFailure(int statusCode, Header[] headers, byte[] errorResponse, Throwable e) {
                ...
                Toast.makeText(AddPropertyActivity.this, "Network error", Toast.LENGTH_SHORT).show();
            }
            ...
            public void onRetry(int retryNo) {
                ...
                Toast.makeText(AddPropertyActivity.this, "Taking too long", Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    private void uploadForm(String title, String description, String price,
        ...
        params.put("agent_id", new SessionManager(AddPropertyActivity.this).getUserID());
        ...
        mProgressDialog = new ProgressDialog(AddPropertyActivity.this);
        ...
        client.post(AppData.createProperty(), params, new AsyncHttpResponseHandler() {
            ...
            public void onSuccess(int statusCode, Header[] headers, byte[] response) {
                ...
                try {
                    ...
                    if (error == 0 && status == 1) {
                        Toast.makeText(AddPropertyActivity.this, "Added successfully", Toast.LENGTH_LONG).show();

                        //// TODO: 11/30/17 Intent redirect to agents pending properties
                        Intent i = new Intent(AddPropertyActivity.this, DrawerActivity.class);
                        ...
                        Toast.makeText(AddPropertyActivity.this, "Failed", Toast.LENGTH_LONG).show();
                    } else {
                        Toast.makeText(AddPropertyActivity.this, "Unknown error", Toast.LENGTH_LONG).show();
                    }
    ...
    private void retrievePropertyTypes() {
        ...
        client.get(AppData.getPropertyTypes(), new AsyncHttpResponseHandler() {
            ...
            public void onSuccess(int statusCode, Header[] headers, byte[] response) {
                ...
                try {
                    ...
                    ArrayAdapter<String> typeSpinner = new ArrayAdapter<String>(AddPropertyActivity.this, android.R.layout.simple_spinner_item, types);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_settings) {
            Intent i = new Intent(AddPropertyActivity.this, TopSettingsActivity.class);
            startActivity(i);
            return true;
        }
